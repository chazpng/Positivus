<?php
/**
 * Stacked Flyout Menu Template.
 *
 * @package greydientlab
 */

?>
<div class="stacked-flyout-menu">
	...
	<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5"></path>
			...
			<div class="hidden lg:flex lg:gap-x-12">
				<div class="relative" @keydown.escape="onEscape" @close-popover-group.window="onClosePopoverGroup">
					<button type="button" class="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900" @click="open = true" @mousedown="if (open) $event.preventDefault()" aria-expanded="false" :aria-expanded="open.toString()">
						Product
