...
<?php if ( 'split-pattern' === get_field( 'with_form_type' ) ) : ?>
	<div class="relative isolate <?php echo esc_html( $bg_color ); ?> split-pattern ">
		<div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2 <?php echo esc_html( $style_mode ); ?>">
...
<?php if ( 'split-image' === get_field( 'with_form_type' ) ) : ?>
	<div class="relative <?php echo esc_html( $bg_color ); ?> split-image">
		...
		<div class="pb-24 pt-16 sm:pb-32 sm:pt-24 lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:pt-32 <?php echo esc_html( $style_mode ); ?>">
...
<?php endif; ?>
<?php 
if ( 'testimonial' === get_field( 'with_form_type' ) ) :
	...
	<div class="relative isolate <?php echo esc_html( $bg_color ); ?> px-6 py-24 sm:py-32 lg:px-8 testimonial">
		...
		<div class="mx-auto max-w-xl lg:max-w-4xl">
			...
			<div class="mt-16 flex flex-col gap-16 sm:gap-y-20 lg:flex-row <?php echo esc_html( $style_mode ); ?>">
				<?php echo do_shortcode( get_field( 'shortcode' ) ); ?>
...
<?php if ( 'simple' === get_field( 'with_form_type' ) ) : ?>
	<div class="isolate <?php echo esc_html( $bg_color ); ?> px-6 py-24 sm:py-32 lg:px-8 simple-centered  <?php echo esc_html( $style_mode ); ?>">
		<?php if ( 'is-style-light' === $style ) : ?>
