...
<?php if ( 'column' === get_field( 'without_form_type' ) ) : ?>
	...
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		...
		<h2 class="text-3xl font-bold tracking-tight text-gray-900"><?php echo esc_html( $main_title ); ?></h2>
		...
		<?php if ( have_rows( 'contact_list' ) ) : ?>
			...
			while ( have_rows( 'contact_list' ) ) :
				...
				?>
			<div>
				<h3 class="border-l border-indigo-600 pl-6 font-semibold text-gray-900"><?php echo esc_html( $country ); ?></h3>
...
<?php if ( 'simple' === get_field( 'without_form_type' ) ) : ?>
	...
	<div class="mx-auto max-w-2xl sm:text-center">
		...
		<p class="mt-2 text-lg leading-8 text-gray-600"><?php echo esc_html( $main_description ); ?></p>
	</div>
	<div class="mx-auto mt-20 max-w-lg space-y-16">
		<?php if ( have_rows( 'contact_list' ) ) : ?>
			...
			<div>
				<h3 class="text-base font-semibold leading-7 text-gray-900"><?php echo esc_html( $contact_label ); ?></h3>
				<p class="mt-2 leading-7 text-gray-600"><?php echo esc_html( $contact_description ); ?></p>
				<p class="mt-4">
				<a href="<?php echo esc_attr( $contact_link ); ?>" class="text-sm font-semibold leading-6 text-indigo-600"><?php echo esc_html( $contact_link_name ); ?><span aria-hidden="true">&rarr;</span></a>
				</p>
			</div>
			</div>
			<?php endwhile; ?>
			...
			<div class="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-3 pt-16">
				...
				<?php if ( have_rows( 'contact_list' ) ) : ?>
					...
					<div class="rounded-2xl bg-gray-50 p-10">
						<h3 class="text-base font-semibold leading-7 text-gray-900"><?php echo esc_html( $contact_list_label ); ?></h3>
