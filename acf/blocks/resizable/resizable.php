	...
	<div class="items-center justify-center max-w-screen-2xl m-auto">
		<div class="flex justify-between">
			...
			<div class="flex items-center">
				...
				<button class="copy-code group relative ml-2 hidden items-center justify-center sm:flex ring-1 ring-gray-200 px-4 py-3 gap-x-2 text-gray-700 text-sm font-medium rounded-lg hover:bg-slate-200/20 shadow-sm" data-id="<?php echo esc_attr( $uniqid ); ?>">
					<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
