...
$form_container   = 'mx-auto mt-10 flex flex-col max-w-md gap-x-4 oncard-center';
...
<div class="<?php echo esc_attr( $bg_color ); ?> py-16 sm:py-24">
	<div class="<?php echo esc_attr( $outer_container ); ?>">
		<div class="<?php echo esc_attr( $inner_container ); ?>">
			<h2 class="mx-auto max-w-2xl <?php echo esc_attr( $text_alignment ); ?> text-3xl font-bold tracking-tight text-white sm:text-4xl"><?php echo esc_html( $main_title ); ?></h2>
			<?php if ( get_field( 'description' ) ) : ?>
				<p class="mx-auto mt-2 max-w-xl <?php echo esc_attr( $text_alignment ); ?> text-lg leading-8 text-gray-300"><?php echo esc_html( $description ); ?></p>
			<?php endif; ?>
			<div class="<?php echo esc_attr( $form_container ); ?> <?php echo esc_attr( $newsletter_style ); ?>">
				<?php echo do_shortcode( get_field( 'shortcode' ) ); ?>
				<div id="hellow"><?php echo wp_kses_post( get_field( 'label' ) ); ?></div>
			</div>
