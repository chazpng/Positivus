...
<div class="<?php echo esc_attr( $bg_color ); ?> py-24 sm:py-32">
	...
	<div class="mx-auto mt-16 flex max-w-2xl flex-col gap-8 lg:mx-0 lg:mt-20 lg:max-w-none lg:flex-row lg:items-end [&>div:first-child]:bg-gray-900 [&>div:last-child]:bg-indigo-600">
	...
	<div class="flex flex-col-reverse justify-between gap-x-16 gap-y-8 rounded-2xl  p-8 sm:w-11/12 sm:max-w-xl sm:flex-row-reverse sm:items-end lg:w-full lg:max-w-none lg:flex-auto lg:flex-col lg:items-start lg:gap-y-28">
