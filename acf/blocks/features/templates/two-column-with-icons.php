<?php
/**
 * Simple Two Columns With Small Icons Template.
 *
...
<div class="bg-gray-900 py-24 sm:py-32">
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="mx-auto max-w-2xl lg:mx-0">
			...
			<p class="mt-2 text-3xl font-bold tracking-tight text-black sm:text-4xl"><?php echo esc_html( $main_title ); ?></p>
			<p class="mt-6 text-lg leading-8 text-black"><?php echo esc_html( $description ); ?></p>
		</div>
		<?php if ( have_rows( 'list' ) ) : ?>
			<dl class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base leading-7 text-black sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:gap-x-16">
				<?php
				while ( have_rows( 'list' ) ) :
					...
					<div class="relative pl-9">
						<dt class="inline font-semibold text-black">
							<?php echo wp_get_attachment_image( $icon, 'full', '', array( 'class' => 'absolute left-1 top-1 h-5 w-5' ) ); ?>
			...
			<?php else : ?>
				<dl class="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base leading-7 text-black sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:gap-x-16">
					<div class="relative pl-9">
						<dt class="inline font-semibold text-black">
							<svg class="absolute left-1 top-1 h-5 w-5 text-purple" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
