<?php
/**
 * Simple Three Column with Large Icon Template.
 *
			...
			<?php if ( have_rows( 'list' ) ) : ?>
				<dl class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
					...
					while ( have_rows( 'list' ) ) :
						...
						$button_name      = empty( get_sub_field( 'button_name' ) ) ? 'Link Here' : get_sub_field( 'button_name' );
						?>
						<div class="flex flex-col">
							<dt class="text-base font-semibold leading-7 text-gray-900">
								<div class="mb-6 flex h-10 w-10 items-center justify-center rounded-lg bg-purple">
							...
							<dd class="mt-1 flex flex-auto flex-col text-base leading-7 text-gray-600">
								<p class="flex-auto"><?php echo esc_html( $list_description ); ?></p>
								<p class="mt-6">
									<a href="#" class="text-sm font-semibold leading-6 text-indigo-600"><?php echo esc_html( $button_name ); ?> <span aria-hidden="true">→</span></a>
								</p>
							</dd>
						</div>
					<?php endwhile; ?>
