<?php
/**
 * With Testimonial and Stats Template.
 *
...
$quotee               = get_field( 'quotee' ) ?: 'Avatar Name';
		...
		<div class="mx-auto grid max-w-2xl grid-cols-1 items-start gap-x-8 gap-y-16 sm:gap-y-24 lg:mx-0 lg:max-w-none lg:grid-cols-2">
			<div class="lg:pr-4">
				<div class="relative overflow-hidden rounded-3xl bg-gray-900 px-6 pb-9 pt-64 shadow-2xl sm:px-12 lg:max-w-lg lg:px-8 lg:pb-8 xl:px-10 xl:pb-10">
					<?php echo wp_get_attachment_image( get_field( 'featured_image' ), 'full', '', array( 'class' => 'absolute inset-0 h-full w-full object-cover brightness-125 saturate-0' ) ); ?>
					...
					<div class="absolute left-1/2 top-1/2 -ml-16 -translate-x-1/2 -translate-y-1/2 transform-gpu blur-3xl" aria-hidden="true">
						<div class="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr <?php echo esc_attr( $gradient_color ); ?> opacity-40" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
					</div>
					<figure class="relative isolate">
						...
						<figcaption class="mt-6 text-sm leading-6 text-gray-300"><strong class="font-semibold text-white"><?php echo esc_html( $quotee ); ?>,</strong> <?php echo esc_html( $position ); ?></figcaption>
					</figure>
				</div>
			</div>
			<div class=" <?php echo esc_attr( $text_color_caption ); ?>">
				<div class="text-base leading-7 lg:max-w-lg">
