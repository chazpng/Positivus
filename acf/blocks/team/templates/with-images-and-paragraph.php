			...
			<ul role="list" class="mx-auto grid max-w-2xl grid-cols-1 gap-x-6 gap-y-20 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:gap-x-8 xl:col-span-2">
				...
				while ( have_rows( 'team_list' ) ) :
					...
					<li>
						...
						<h3 class="mt-6 text-lg font-semibold leading-8 text-gray-900"><?php echo esc_html( $name ); ?></h3>
						<p class="text-base leading-7 text-gray-600"><?php echo esc_html( $position ); ?></p>
						<p class="mt-4 text-base leading-7 text-gray-600"><?php echo esc_html( $description ); ?></p>
