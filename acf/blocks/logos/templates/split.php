...
$heading_color             = 'is-style-dark' === $style ? 'text-white' : 'text-gray-900';
$desc_color                = 'is-style-dark' === $style ? 'text-gray-300' : 'text-gray-600';
$secondary_link_color      = 'is-style-dark' === $style ? 'text-white' : 'text-gray-900';
?>
...
<div class="<?php echo esc_attr( $bg_color ); ?> py-24 sm:py-32">
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2">
			...
			<h2 class="text-3xl font-bold tracking-tight <?php echo esc_attr( $heading_color ); ?>"><?php echo esc_html( $heading ); ?></h2>
			<p class="mt-6 text-lg leading-8 <?php echo esc_attr( $desc_color ); ?>"><?php echo wp_kses_post( $description ); ?></p>
			...
			<?php if ( $cta_button_link_secondary ) : ?>
				<a href="<?php echo esc_url( $cta_button_link_secondary['url'] ); ?>" <?php echo $cta_button_link['target'] ? 'target="_blank"' : ''; ?> class="text-sm font-semibold <?php echo esc_attr( $secondary_link_color ); ?>">
