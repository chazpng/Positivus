 ...
 * Load::molecule( 'dialogs/centered-with-single-action', array('key' => 'value') );
 *
...
<div class="relative z-10" aria-labelledby="modal-title" role="dialog" aria-modal="true" x-data="{ open: false }">
	<!--
		...
		Leaving: "ease-in duration-200"
			...
			To: "opacity-0"
	-->
	<div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" @click.outside="open=false"></div>
